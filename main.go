...
func loginFormHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		if session_pointer != nil {
			...
			if session_pointer != nil && session_pointer.ExpiresAt.After(time.Now()) {
				// Cookie is expired
...
3. Session per client connection - 2023-12-09 -> DONE 
...
9. Publish website -> IN PROGRESS (Fixing bugs & need to find better deployment service)
10. Fixed the file reading implementation - SEPARATE GETTING THE FILE AND DOING THE STUFF!
*/
